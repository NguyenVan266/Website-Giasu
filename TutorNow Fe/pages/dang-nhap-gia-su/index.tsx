		...
		if (formIsValid) {
			try {
				...
				if (response.data === null) {
					...
					window.location.href = '/gia-su/quan-ly-trang-chu-gs'
				}
			} catch (error) {
				console.log(error)
			}
			...
			<section className="login_uv login_uv_mb">
				<div className="vieclam_container" style={{ background: 'unset' }}>
					<div className="login_content">
						<h1>Đăng nhập tài khoản gia sư</h1>
					</div>
					<div className="form_dang_nhap form_dn_uv">
						<div className="login_logo_header">
							<img src="/images/New_images/logo_login1.png" alt="alt" />
						</div>
...
Dangnhapgiasu.Layout = MainLayout
export default Dangnhapgiasu
